...
int main( int argcount, char* arguments[] )
{
	...
	vector<pair<vector<string>, pair<vector<vector<string>>, vector<vector<string>>>> functions;
	...
	{  
		...
		{ 
			...
			else if(tokens[0] == "function")
			{
				...
				int f1 = 1, f2 = 0;
				while(getline(file, s) && s.substr(0, 3) != end)
				{ 
					//cout << s << endl;
					char s1[s.size()+1];
					strcpy(s1, s.c_str());
				...
				functions.push_back(make_pair(prime, make_pair(args, vars)));
				for(int i=0; i<functions.size(); i++){
					for(int k=0; k<functions.first.size(); k++){
						cout<<functions.first[k]<<" ";
					}
					cout<<endl;
					for(int k=0; k<functions.second.first.size(); k++){
						cout<<functions.second.first[k]<<" ";
					}
					cout<<endl;
					for(int l=0; l<functions.second.second.size(); l++){
						cout<<functions.second.second[l]<<" ";
					}
					cout<<endl;
				}
			}
